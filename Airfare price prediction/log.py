...
#
label_l1 = tk.Label(root, text="___Airfare price prediction___",font=("Times New Roman", 30, 'bold'),
                    background="#FFA07A", fg="maroon", width=60, height=1)
...
title=tk.Label(root, text="Login Here", font=("Times new roman", 25, "bold","italic"),bd=3,bg="#FFE4B5",fg="black")
title.place(x=960,y=100,width=200)
        
Login_frame=tk.Frame(root,bg="#FFA07A")
Login_frame.place(x=830,y=150)
...
btn_log=tk.Button(Login_frame,text="Login",command=login,width=15,font=("Times new roman", 14, "bold"),bg="#FA8072",fg="black")
btn_log.grid(row=3,column=1,pady=10)
btn_reg=tk.Button(Login_frame,text="Create Account",command=reg,width=15,font=("Times new roman", 14, "bold"),bg="#FA8072",fg="black")
...
label_l1 = tk.Label(root, text="** House price prediction Prediction @2023 By __ **",font=("Times New Roman", 10, 'bold'),
