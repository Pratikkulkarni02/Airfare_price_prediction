...
# label_l1 = tk.Label(root, text="Airfare price prediction",font=("Times New Roman", 30, 'bold'),
#                     background="#607B8B", fg="white", width=60, height=2)
...
frame_alpr = tk.LabelFrame(root, text=" --Register-- ", width=600, height=580, bd=5, font=('times', 14, ' bold '),fg="white",bg="#607B8B")
frame_alpr.grid(row=0, column=0, sticky='nw')
frame_alpr.place(x=350, y=100)
